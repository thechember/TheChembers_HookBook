...
STRUCTURE:
1. FIRST PARAGRAPH — location/environment description. One dense paragraph, no label, no header. Describe: exact room/space type, time of day, light source and quality (natural window light, overcast daylight, warm evening lamp etc.), wall/floor/furniture colors and textures, visible props and background details, overall atmosphere. This replaces the need for a reference photo — it must be specific enough to generate the environment without any additional input.

2. SHOT BREAKDOWN — sequential shots using markers: [Shot 1 · 0-4s] [Shot 2 · 4-8s] etc, filling the full 15s.
...
const DEMO_HOOKS = [
  {id:"H1",mechanism:"expert_confession",pattern_benchmark:"Expert Confession body — 11,247 purchases",format:"studio_two_experts",characters:[{role:"LONGEVITY EXPERT",relationship:"hero persona"},{role:"BOTOX GIRL",relationship:"contrast character"}],hook_line:"She has spent more on anti-aging this year than most people spend on a car. Her biological age is three years older than mine.",dialogue:[{speaker:"LONGEVITY EXPERT",line:"She has spent more on anti-aging this year than most people spend on a car."},{speaker:"LONGEVITY EXPERT",line:"Her biological age is three years older than mine."},{speaker:"LONGEVITY EXPERT",line:"And I've never had a single procedure."}],visual_action:"Two women at a restaurant table. Expert looks composed, plainly dressed. Botox girl polished, glances over, growing uneasy. Contrast visible from frame one.",video_prompt:"Upscale restaurant interior, daytime. Floor-to-ceiling windows flood the space with cool, diffused natural light. Round table with white linen, two half-filled water glasses, a small floral centerpiece. Warm neutral walls, dark wood chairs, blurred background of other diners. Clean, lived-in, no artificial light sources.\n\n[Shot 1 · 0-4s] Medium two-shot, LONGEVITY_EXPERT (50s, calm, plainly dressed) screen-left, BOTOX_GIRL (polished, highlighted) screen-right. Expert looks to camera, quiet authority: \"She has spent more on anti-aging this year than most people spend on a car.\"\n[Shot 2 · 4-9s] Tighter single on LONGEVITY_EXPERT, camera stays screen-left. Unbothered expression: \"Her biological age is three years older than mine.\"\n[Shot 3 · 9-13s] Slow push-in, micro-pause, eye contact: \"And I've never had a single procedure.\" BOTOX_GIRL shifts in peripheral.\n[Shot 4 · 13-15s] Hold two-shot, tension, no dialogue. Handheld phone-camera feel, natural light only.",consumer_language_used:["biological age","personalized protocol","aging is modifiable"],duration_sec:15,emotional_anchor:"quiet dissonance",cta_type:"curiosity_gap"},
